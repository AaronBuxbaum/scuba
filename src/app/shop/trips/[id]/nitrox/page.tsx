...
export default async function TripNitroxPage({
  ...
  const back = `/shop/trips/${tripId}/nitrox`;
      ...
      <section className="mt-10">
        ...
        {tanks.length === 0 ? (
          <p className="mt-4 rounded-lg border border-border bg-surface p-4 text-sm text-muted">
            ...
            <Link href="/shop/gear" className="font-medium text-primary hover:underline">
              gear page
            </Link>{" "}
            first.
          </p>
            ...
            <label className="flex flex-col gap-1 text-sm font-medium sm:col-span-2">
              ...
              {anyCertified ? null : (
                <span className="text-xs text-warning">
                  ...
                  <Link href="/shop/nitrox" className="font-medium underline">
                    nitrox page
                  </Link>
                  .
                </span>
